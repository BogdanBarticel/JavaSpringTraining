...
insert into location (name, country, city, county, street) values ('Depo No 1', 'Romania', 'Iasi', 'Iasi', 'Bul Poitiers 11');
insert into location (name, country, city, county, street) values ('Depo No 2', 'Romania', 'Bucuresti', 'Ilfov', 'Bulevardul Eroilor 1');
insert into location (name, country, city, county, street) values ('Depo No 3', 'Romania', 'Cluj-Napoca', 'Cluj', ' Samuel Brassai 6');
...
insert into stock (location_id, product_id, quantity) values (1,3, 11);
insert into stock (location_id, product_id, quantity) values (1,4, 10);
insert into stock (location_id, product_id, quantity) values (2,1, 6);
insert into stock (location_id, product_id, quantity) values (2,2, 20);
insert into stock (location_id, product_id, quantity) values (2,3, 7);
insert into stock (location_id, product_id, quantity) values (2,4, 10);
insert into stock (location_id, product_id, quantity) values (2,5, 1);
...
insert into stock (location_id, product_id, quantity) values (3,5, 16);
insert into stock (location_id, product_id, quantity) values (3,8, 10);
